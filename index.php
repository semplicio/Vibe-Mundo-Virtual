...
<section class="world-shell"><div class="scene" id="scene" tabindex="0">
<div class="road road-horizontal"></div><div class="road road-vertical"></div>
<div class="square"><div class="square-icon">🏛️</div><strong>Praça Central</strong><small>Centro do Mundo Virtual</small></div>
...
<div class="instructions">Use <kbd>WASD</kbd> ou as setas para explorar. Selecione uma loja para entrar.</div>
...
<p class="status" id="status" aria-live="polite">Você está na Praça Central.</p>
